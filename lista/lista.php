          ...
          "columns": [
            ...
            { "data": "id", 
                "render": function(data, row){
                  ...
                  var bonificar = '<a class="btn btn-info teste" href="/MiniProject/lista/bonificar/bonificar.php?id_funcionario='+data+'">Bonificar</a>';
                  var altSalario = '<a class="btn btn-info teste" href="/MiniProject/lista/atualizar/alterar_salario.php?id_funcionario_update='+data+'">Alterar salário</a>';
...
<body>
  <nav aria-label="breadcrumb" style=" padding: 10px 310px">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a class="btn btn-info teste" href="/MiniProject/index.html">Voltar</a></li>
    </ol>
  </nav>
  <div class="container">
